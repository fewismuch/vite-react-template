import {GithubFilled, InfoCircleFilled, QuestionCircleFilled, RedoOutlined} from '@ant-design/icons'
    ...
    return (
        <div className='h-[100vh]'>
            <ProLayout
                ...
                {...settings}
            >
                <MultiTabs items={newTabsItems(tabsItems)} activeKey={activeTabsItem}
                           onChange={(path) => addTab(path)}></MultiTabs>
